...
此源码快照以 `20260914.03-gbc6d2699-dirty / sample-verified` 样品固件的功能为参考。该版本让 NORMAL 模式的六个 Agent 键使用与 CODEX 一致的有效来源、标准状态颜色和断线／未知回白色规则，并可选择 AG00–AG05；NORMAL 其他控件仍走 Profile。源码生成的是自定义构建，不是官方签名包，也不承诺与官方镜像逐字节一致。具体来源和验收范围见 [SOURCE.md](SOURCE.md)。
