...
V4_TOKENS = {
    ...
    "faint": "#7E796F", "control": "#4C6EE8", "signal": "#CC5200",
...
QCheckBox::indicator:focus { border-color: #8CA9FF; }
...
QLabel#deviceAuthSummary[trust="authenticated"], QLabel#devicePanelValue[state="ready"], QLabel#devicePanelLive { color: #8FB98F; }
...
QPushButton#primary, QPushButton[buttonRole="primary"] { background: #4C6EE8; color: #FFFFFF; border: 1px solid rgba(255,255,255,61); border-radius: 20px; font-weight: 600; }
QPushButton#primary:hover, QPushButton[buttonRole="primary"]:hover { background: #5C7BF0; }
QPushButton#primary:disabled, QPushButton[buttonRole="primary"]:disabled { background: #34394E; color: #9A958C; border-color: transparent; }
...
QPushButton#shortcutRecordButton, QPushButton#shortcutRecordButton[recording="true"], QPushButton#settingsLanguageButton[active="true"] { background: #EFEAE0; color: #1C1B19; border: none; border-radius: 14px; min-height: 28px; padding: 0 13px; }
...
QFrame#mappingEditorCard QLineEdit, QFrame#mappingEditorCard QComboBox, QFrame#mappingEditorCard QSpinBox {
    background: #2B2A27; color: #EFEAE0; border: 1px solid rgba(239,234,224,26); border-radius: 20px; min-height: 38px; padding: 0 16px; selection-background-color: #4C6EE8;
}
QComboBox:focus, QLineEdit:focus, QSpinBox:focus, QTextEdit:focus, QPlainTextEdit:focus { border-color: #EFEAE0; }
QComboBox QAbstractItemView { background: #242320; color: #EFEAE0; border: none; border-radius: 18px; selection-background-color: #3A3833; selection-color: #EFEAE0; }
QTextEdit, QPlainTextEdit, QListWidget { background: #232220; color: #EFEAE0; border: 1px solid rgba(239,234,224,26); border-radius: 25px; padding: 12px 14px; selection-background-color: #4C6EE8; }
...
QProgressBar { background: #232220; border: none; border-radius: 6px; color: #EFEAE0; }
QProgressBar::chunk { background: #9FB3EE; border-radius: 6px; }
...
""" + MACOS_GLASS_MENU_STYLE + TOGGLE_STYLE
